...
final class CustomerBalanceIncreased extends BaseDomainEvent implements DomainEvent, CustomerBalanceUpdatedEvent
{
    ...
    {
        return 'dogebank.customer.balance_increased';
    }
